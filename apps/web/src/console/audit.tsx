...
const eventMessages: Partial<Record<string, MessageKey>> = {
  ...
  'native.desktop_connection_failed': 'auditDesktopConnectionFailed',
  ...
  'agent.desktop_lease_revoked': 'auditAgentLeaseRevoked',
  'agent.computer_action_succeeded': 'auditComputerActionSucceeded',
  'agent.computer_action_failed': 'auditComputerActionFailed',
  'agent.computer_action_denied': 'auditComputerActionDenied',
  ...
  'user.password_changed': 'auditUserPasswordChanged',
  'user.password_change_failed': 'auditUserPasswordChangeFailed',
  'user.password_reset': 'auditUserPasswordReset',
  'api_token.created': 'auditAPITokenCreated',
  'api_token.revoked': 'auditAPITokenRevoked',
